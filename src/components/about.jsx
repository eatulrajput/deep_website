  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8 p-8 bg-white dark:bg-gray-900 bg-opacity-80 dark:bg-opacity-80 backdrop-blur-2xl rounded-2xl mx-7 shadow-lg transition-all duration-300">
      ...
      <div className="pl-6 sm:pl-10">
        <h1 className="text-left font-bold text-2xl md:text-3xl lg:text-4xl  text-gray-900 dark:text-white">
          Deep
        </h1>
        <h1 className="text-left font-bold text-2xl md:text-3xl lg:text-4xl  text-gray-900 dark:text-white">
          Habishwashi
        ...
        <p className="text-left text-lg  text-gray-800 dark:text-gray-300 leading-relaxed">
        ...
        <p className="mt-4 text-left text-lg  text-gray-800 dark:text-gray-300 leading-relaxed">
...
const InfoBlock = ({ title, items }) => (
  <div className="p-4">
    <h2 className="text-left font-bold text-xl md:text-2xl  text-gray-900 dark:text-white">
      {title}
    </h2>
    <ul className="mt-2 list-none space-y-1">
      {items.map((item, index) => (
        <li key={index} className="text-left font-light text-lg  text-gray-700 dark:text-gray-400">
          &bull; {item}
        </li>
      ))}
    </ul>
